...
грядке, причём кусты высажены только по окружности. Таким образом, у каждого куста есть
...
n = int(input(' введите диапазон ягод сколько нужно собрать с куста от : '))
m = int(input(' введите диапазон ягод сколько нужно собрать с куста до : '))

for i in range(5):
    array_1.append(randint (n,m))
print(array_1)

for i in range (len(array_1)):
    sum_3 = sum(array_1[i:i+3])
    print(sum_3, end= ';')
